...
const FAQ_SCHEMA_ITEMS = [
  { question: "Combien coûte la création d'un site web en Algérie ?", answer: "Chez XenonDz, un site vitrine professionnel commence à partir de 20 000 DZD et une boutique e-commerce à partir de 120 000 DZD. Le prix final dépend de vos besoins spécifiques. Nous proposons des devis gratuits et transparents sous 24h." },
  { question: "Combien coûte une boutique e-commerce en Algérie ?", answer: "Notre offre e-commerce complète démarre à 120 000 DZD. Elle inclut le catalogue produits, la gestion des stocks, l'intégration des livraisons (Yalidine, Maystro), le paiement à la livraison et une formation complète à la gestion." },
