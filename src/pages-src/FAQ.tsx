...
const FAQ_SCHEMA_ITEMS = [
  ...
  { question: "Comment se déroule le paiement ?", answer: "50% à la signature du devis, 50% à la livraison. Nous acceptons les paiements par virement bancaire et carte bancaire. Des facilités de paiement sont possibles pour les projets importants." },
  ...
  { question: "Que se passe-t-il si mon site tombe en panne ?", answer: "Vous nous contactez et nous intervenons sous 4h en jours ouvrés. Pour les clients avec contrat de maintenance, nous disposons d'une surveillance automatique." },
  { question: "Est-ce que mon site sera bien référencé sur Google ?", answer: "Oui, le SEO on-page est inclus dans tous nos projets : structure sémantique, balises optimisées, performance de chargement, sitemap et robots.txt." },
  ...
  { question: "Travaillez-vous avec des entreprises hors de l'Algérie ?", answer: "Pour l'instant, nous travaillons exclusivement en Algérie, sauf rare exception. Nous concentrons nos efforts sur le marché local." },
];
