...
export const translations = {
  fr: {
    ...
    home: {
      ...
      heroDesc:
        "Création de sites web sur mesure, e-commerce et automatisation pour les entreprises algériennes.",
      ...
      packsLabel: "Nos formules",
      packsTitle: "Choisissez votre formule",
      packsSubtitle: "Des offres claires, sans surprise. Devis gratuit sous 24h.",
      packBadgePopular: "Le plus populaire",
      packs: [
        {
          name: "Vitrine",
          price: "dès 20 000 DZD",
          tagline: "Votre présence en ligne, professionnelle et rapide.",
          features: [
          ...
          href: "/services/creation-site-web-vitrine",
          highlighted: false,
        },
        {
          name: "Business",
          ...
          href: "/services/creation-boutique-ecommerce",
          highlighted: true,
        },
        {
          name: "Full Stack",
          price: "Sur devis",
          tagline: "E-commerce complet + automatisation Python sur mesure.",
          features: [
            "Tout le pack Business",
            "Automatisation Python sur mesure",
            "Scripts WhatsApp, CRM, facturation",
            "Intégration systèmes existants",
          ],
          cta: "Discuter de mon besoin",
          href: "/services/automatisation-generation-leads",
          highlighted: false,
        },
      ],
  ...
  en: {
    ...
    home: {
      ...
      heroDesc:
        "Custom websites, e-commerce and automation for Algerian businesses.",
      ...
      packsLabel: "Our packages",
      packsTitle: "Choose your plan",
      packsSubtitle: "Clear, transparent pricing. Free quote within 24h.",
      packBadgePopular: "Most popular",
      packs: [
        {
          name: "Vitrine",
          price: "From 20,000 DZD",
          tagline: "Your professional online presence, delivered fast.",
          features: [
        ...
        {
          name: "Business",
          price: "From 120,000 DZD",
          tagline: "A complete e-commerce store for the Algerian market.",
          features: [
        ...
        },
        {
          name: "Full Stack",
          price: "Custom quote",
          tagline: "E-commerce + custom Python automation.",
          features: [
            "Everything in Business",
            "Custom Python automation",
            "WhatsApp, CRM, invoicing scripts",
  ...
  ar: {
    ...
    home: {
      ...
      heroDesc:
        "تصميم مواقع على المقاس، تجارة إلكترونية وأتمتة للمؤسسات الجزائرية.",
      heroCta: "ابدأ مشروعك",
      ...
      packsLabel: "عروضنا",
      packsTitle: "اختر الباقة المناسبة",
      packsSubtitle: "أسعار واضحة وشفافة. عرض مجاني خلال 24 ساعة.",
      packBadgePopular: "الأكثر طلباً",
      packs: [
        {
          name: "Vitrine",
          price: "ابتداءً من 20,000 دج",
          tagline: "حضورك المهني على الإنترنت، بسرعة وجودة.",
          features: [
            "تصميم خاص (بدون قوالب جاهزة)",
            "تحسين محركات البحث مشمول",
            "تسليم مضمون في 7 أيام",
            "دعم تقني 6 أشهر مجاناً",
          ],
          cta: "طلب عرض سعر",
          href: "/services/creation-site-web-vitrine",
          highlighted: false,
        },
        {
          ...
          tagline: "متجر إلكتروني متكامل للسوق الجزائري.",
          features: [
            "كل مزايا باقة Vitrine",
        ...
        },
        {
          name: "Full Stack",
          price: "حسب الطلب",
          tagline: "تجارة إلكترونية + أتمتة Python على المقاس.",
          features: [
            "كل مزايا باقة Business",
            "أتمتة Python مخصصة",
            "سكريبتات واتساب، CRM، فوترة",
            "تكامل مع الأنظمة القائمة",
          ],
          cta: "مناقشة احتياجاتي",
          href: "/services/automatisation-generation-leads",
          highlighted: false,
        },
      ],
